 ...
 */
final class Version20240411073305 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE user_campaign (user_id INT NOT NULL, campaign_id INT NOT NULL, INDEX IDX_FF98F6DDA76ED395 (user_id), INDEX IDX_FF98F6DDF639F774 (campaign_id), PRIMARY KEY(user_id, campaign_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
